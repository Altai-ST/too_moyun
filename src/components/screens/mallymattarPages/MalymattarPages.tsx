...
const MalymattarPages: FC<idCard> = id => {
	...
	return (
		<>
			<h1 className='w-full text-center text-4xl font-bold text-red-600 mb-20'>{cardEl[0] === undefined ? <></> : cardEl[0].title}</h1>
			<div className='flex laptop:px-24 laptop:mb-32 laptop:flex-row flex-col px-6 mb-4'>
				<Image
					...
					src={cardEl[0] === undefined ? "" : typeof cardEl[0].img === 'string' ? cardEl[0].img : ""}
					alt=''
					width={711}
					height={499}
				/>
				<div className='laptop:w-40% flex flex-col laptop:justify-center laptop:items-start mobile:items-center'>
					...
					<h2 className='laptop:text-2xl font-bold text-cardColor text-base'>{cardEl[0] === undefined ? '' :cardEl[0].sub_title}</h2>
					<p className='laptop:w-500 text-newsColor laptop:text-lg text-sm w-388'>{cardEl[0] === undefined ? <></> : cardEl[0].text}</p>
				</div>
			</div>
				...
				{size.width === undefined ? (
					...
					<div className='flex'>
						<Image
							...
							src={cardEl[0] === undefined ? "" : typeof cardEl[0].img_1 === 'string' ? cardEl[0].img_1 : ""}
							alt=''
							width={340}
							height={250}
						/>
						<Image
							className='mr-2 max-h-250'
							src={cardEl[0] === undefined ? "" : typeof cardEl[0].img_2 === 'string' ? cardEl[0].img_2 : ""}
							alt=''
							width={340}
							height={250}
						/>
						<Image
							className='mr-2 max-h-250'
							src={cardEl[0] === undefined ? "" : typeof cardEl[0].img_3 === 'string' ? cardEl[0].img_3 : ""}
							alt=''
							width={340}
							height={250}
						/>
